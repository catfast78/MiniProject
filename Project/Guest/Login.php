...
.overlay {
	background: #e5cf08;
	background: -webkit-linear-gradient(to right, #d3de0e, #e1bd62);
	background: linear-gradient(to right, #dcdc3c, #f9c300);
...
<div class="container" id="container">
	...
	<div class="form-container sign-in-container">
		<form action="" method="post">
            ...
            <input type="text" name="txt_email" placeholder="Email or Phone" id="username">
	...
	<div class="overlay-container">
		<div class="overlay">
			...
			<div class="overlay-panel overlay-right">
				...
				<a href ="userRegistration.php"><button class="ghost" id="signUp">Sign Up</button></a>
			</div>
		</div>
	</div>
</div>
