...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=422878797ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=miniproject&table=tbl_place">`miniproject`.`tbl_place`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=miniproject&table=tbl_district">`miniproject`.`tbl_district`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=miniproject&table=tbl_user">`miniproject`.`tbl_user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=miniproject&table=tbl_salon">`miniproject`.`tbl_salon`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=miniproject&table=tbl_admin">`miniproject`.`tbl_admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=miniproject&table=tbl_booking">`miniproject`.`tbl_booking`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=miniproject&table=tbl_service">`miniproject`.`tbl_service`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=miniproject&table=tbl_complaint">`miniproject`.`tbl_complaint`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=miniproject&table=tbl_staff">`miniproject`.`tbl_staff`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=miniproject&table=tbl_request">`miniproject`.`tbl_request`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="317a214a3b66544550485e56352c394a">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="miniproject" targettable="tbl_salon">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_salon`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="miniproject" targettable="tbl_user">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_user`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="miniproject" targettable="tbl_user">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `tbl_user` DROP `palce_id`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="miniproject" targettable="tbl_user">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_user`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="miniproject" targettable="tbl_district">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_district`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="miniproject" targettable="tbl_place">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_place`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="miniproject" targettable="tbl_place">
                            <div class="action_content">
